        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="lg:col-span-1 space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              <a
                ...
                className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-white/70 hover:text-neon hover:border-neon/30 transition-all"
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li>
                <a href="tel:+19087675309" className="text-white/70 hover:text-neon text-sm transition-colors flex items-center gap-2">
                  <span className="font-mono">(908) 767-5309</span>
                </a>
              </li>
              <li>
                <a href="mailto:info@a1tradelines.com" className="text-white/70 hover:text-neon text-sm transition-colors">
