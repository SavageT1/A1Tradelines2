  ...
  return (
    <div>
      <SEOHead
        ...
        description="Contact A1 Tradelines to ask questions about authorized user tradeline options, reporting timelines, and profile-based matching. No credit outcome is guaranteed."
      ...
      <PageHero
        title="Contact Us"
        subtitle="Ask about authorized user tradeline options and profile-based matching"
              ...
              <SectionReveal direction="left">
                <div className="space-y-4">
                  ...
                  <p className="text-white/40 leading-relaxed">
                    Have questions about authorized user tradelines, reporting timelines, or profile-based matching? Send a message and our team will respond.
                  </p>
                </div>
              </SectionReveal>
