    ...
    <LegalPage
      content={{
        ...
        sections: [
          ...
          { heading: 'Purchases and refunds', body: ['Prices are shown in the live inventory. Reserving a tradeline is free; no payment is collected until a specialist confirms availability and fit. Our money-back guarantee applies as described in the Refund Policy. Please review it before purchasing.'] },
