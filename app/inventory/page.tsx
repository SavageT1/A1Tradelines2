...
export const metadata: Metadata = {
  title: 'Tradeline Inventory — Find Your Seasoned Tradeline',
  description:
    'Browse the full A1 Tradelines inventory. Sort by price, age, or limit, and see reporting dates and posting windows on every seasoned tradeline. Getting started is free — no payment until a specialist confirms your pick.',
  alternates: { canonical: '/inventory' },
  openGraph: { title: 'Tradeline Inventory — A1 Tradelines', description: 'Browse and pick seasoned authorized-user tradelines.', url: '/inventory' },
}
