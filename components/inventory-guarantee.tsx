...
export function InventoryGuarantee() {
  return (
    <div className="mt-8 flex items-start gap-3 border border-primary/30 bg-primary/5 p-6 text-sm leading-6 text-muted-foreground">
      ...
      <span>If your tradeline does not post to your credit report, you get 100% of your money back. Review the purchase agreement for complete guarantee terms.</span>
    </div>
  )
}
